...
// } from "../../api/api"; // adjust your API path
    ...
    <div className="p-6 bg-green-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold flex items-center gap-2 text-green-700">
          <Bell size={24} /> Notification Dashboard
        </h2>
        <button
      ...
      {loading ? (
        ...
        <div className="text-center text-gray-500 bg-white p-6 rounded-lg shadow">
          <Bell size={32} className="mx-auto mb-2 text-green-400" />
        ...
        <div className="space-y-4">
          {notifications.map((notif) => (
            ...
            >
              <div>
                <h3 className="font-semibold text-green-800">{notif.title}</h3>
