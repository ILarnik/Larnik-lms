        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <label className="flex flex-col">
              ...
              <input
                ...
                value={form.name}
                onChange={handleChange}
                className={`mt-2 p-3 rounded-xl border focus:outline-none focus:ring-2 focus:ring-green-300 ${
                  errors.name ? "border-red-300" : "border-gray-200"
                }`}
                placeholder="Your full name"
              />
            ...
            <label className="flex flex-col">
              ...
              <input
                ...
                value={form.phone}
                onChange={handleChange}
                className="mt-2 p-3 rounded-xl border focus:outline-none focus:ring-2 focus:ring-green-300 border-gray-200"
                placeholder="+91 12345 67890"
              />
            </label>
          </div>
          ...
          <label className="flex flex-col mt-4">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={6}
              className={`mt-2 p-3 rounded-2xl border focus:outline-none focus:ring-2 focus:ring-green-300 ${
                errors.message ? "border-red-300" : "border-gray-200"
              }`}
              placeholder="Tell us what's on your mind"
            />
          ...
          <div className="mt-6 flex items-center gap-3">
            <button
              type="submit"
              disabled={loading}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-green-500 text-white font-medium hover:bg-green-600 transition disabled:opacity-60"
            >
              {loading && (
                <svg
                  className="animate-spin h-4 w-4"
            ...
            <button
              ...
              className="px-6 py-3 rounded-2xl bg-green-500 text-white font-medium hover:bg-green-600 transition"
            >
              Reset
            </button>
          </div>
