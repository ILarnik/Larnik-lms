    ...
    <>
        ...
        <div className="flex gap-2 justify-center">
          <div className="flex justify-center gap-6 mt-10">
            <div className="flex flex-col items-center bg-white p-6 rounded-xl shadow-xl w-64">
              ...
              <p className="text-2xl font-bold text-black mt-3">{stats.students}</p>
          ...
          <div className="flex justify-center gap-6 mt-10">
            <div className="flex flex-col items-center bg-white p-6 rounded-xl shadow-xl w-64">
              ...
              <p className="text-2xl font-bold text-black mt-3">{stats.courses}</p>
          ...
          <div className="flex justify-center gap-6 mt-10">
            <div className="flex flex-col items-center bg-white p-6 rounded-xl shadow-xl w-64">
              ...
              <p className="text-2xl font-bold text-black mt-3">{stats.instructors}</p>
        ...
        <div className="mt-20 grid grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="mt-5">
              ...
              <p className="text-gray-500 text-left text-sm/6 pt-4 flex gap-5">
          ...
          <div className="relative w-fit">
            <img
              className="object-cover rounded-xl w-[600px] h-[300px]"
      ...
      <div className="p-10 flex flex-col items-center justify-center gap-5">
        <div className="w-[580px] flex flex-col items-center justify-center">
          ...
          <p className="text-black pt-5 font-semibold text-center">
      ...
      <div className="p-10 flex flex-col items-center justify-center gap-5">
        <div className="w-[580px] flex flex-col items-center justify-center">
          ...
          <p className="text-gray-500 pt-5 font-semibold">
